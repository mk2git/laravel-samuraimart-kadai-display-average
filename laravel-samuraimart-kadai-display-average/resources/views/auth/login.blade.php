      ...
      <div class="row justify-content-center">
          <div class="col-md-5">
              ...
              <form action="{{route('login')}}" method="post">
                  ...
                  <div class="form-group">
                      <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror samuraimart-login-input" required autocomplete="current-password" placeholder="パスワード">
                  ...
                  <div class="form-group">
                      ...
                      <a class="btn btn-link mt-3 d-flex justify-content-center samuraimart-login-text" href="{{route('password.request')}}">パスワードをお忘れの場合</a>
                  </div>
              </form>
              ...
              <div class="form-group">
                  <a class="btn btn-link mt-3 d-flex justify-content-center samuraimart-login-text" href="{{route('register')}}">新規会員登録</a>
              </div>
          </div>
      </div>
  </div>
