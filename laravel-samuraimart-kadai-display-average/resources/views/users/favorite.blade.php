      ...
      <div class="row">
        @foreach($favorite_products as $favorite_product)
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-end">
            ...
            <a href="{{route('favorites.destroy', $favorite_product->id)}}" class="samuraimart-favorite-item-delete" onclick="event.preventDefault(); document.getElementById('favorites-destroy-form').submit();">削除</a>
            <form id="favorites-destroy-form" action="{{route('favorites.destroy', $favorite_product->id)}}" method="post" class="done">
              @csrf
              @method('delete')
            </form>
          </div>
