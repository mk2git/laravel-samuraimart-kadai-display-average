                                  ...
                                  <div class="col-md-3">
                                      <a href="{{route('products.show', $product->id)}}">
                                          @if ($product->options->image)
                                            <img src="{{$product->options->image}}"  class="img-thumbnail">
                                          @else
                                  ...
                                  <div class="col-md-9">
                                      <div class="flex-column">
                                          ...
                                          <div class="row mb-2">
                                              ...
                                              <div class="col-xxl-9">
                                                  合計：&yen;{{number_format($product->qty * $product->price)}}
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                  ...
                  <div class="col col-xxl-4">
                    <div class="bg-white p-4 m-4">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-7">
                                &yen;{{number_format($total - $carriage_cost)}}
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                &yen;{{number_format($carriage_cost)}}
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-5">
                                <span class="fs-5 w-bold">合計</span>
                            </div>
